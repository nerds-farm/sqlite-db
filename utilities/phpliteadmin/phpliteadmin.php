...
include_once $path . 'authorization.php';
include_once $path . 'database.php';
include_once $path . 'get_parameters.php';
include_once $path . 'resources.php';
include_once $path . 'microtimer.php';
...
if (isset($_GET['resource'])) {
    \PhpLiteAdmin\Resources::output($_GET['resource']);
    exit();
}
/*
...
$auth = new \PhpLiteAdmin\Authorization(); //create authorization object
...
if ($auth->isAuthorized()) {
        ...
        if ($_POST['new_dbname'] == '')
            ...
            if (checkDbName($dbname)) {
                ...
                if (isset($_POST['new_dbtype']))
                    ...
                    $tdata['type'] = 3;
                $td = new \PhpLiteAdmin\Database($tdata);
                $td->query("VACUUM");
            } else {
    ...
    if (isset($_POST['export'])) {
        ...
        if ($_POST['export_type'] == "sql") {
            ...
            $db = new \PhpLiteAdmin\Database($currentDB);
    ...
    if (isset($currentDB)) {
        ...
        $db = new \PhpLiteAdmin\Database($currentDB); //create the Database object
        $db->registerUserFunction($custom_functions);
    }
