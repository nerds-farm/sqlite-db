...
class PDOSQLiteDriver {
    ...
    private function handle_create_query() {
        require_once SQLITE_DB_PATH . 'wp-includes'.DIRECTORY_SEPARATOR . 'integration' . DIRECTORY_SEPARATOR . 'query_create.php';
    ...
    private function handle_alter_query() {
        require_once SQLITE_DB_PATH . 'wp-includes'.DIRECTORY_SEPARATOR . 'integration' . DIRECTORY_SEPARATOR . 'query_alter.php';
