...
class WP_SQLite_Translator extends PDO {
	...
	private function init() {
                //var_dump(SQLite3::version()['versionString']);
		if ( property_exists($this, 'can_insert_multiple_rows') && version_compare( SQLite3::version()['versionString'], '3.7.11', '>=' ) ) {
	...
	private function flush() {
		...
		$this->is_error        = false;
		$this->queries         = array();
		if (property_exists($this, 'param_num')) $this->param_num = 0;
	}
